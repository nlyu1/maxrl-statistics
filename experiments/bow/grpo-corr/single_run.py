...
Artifacts → artifacts/bow-grpo-{hom,row-het,word-het}-sweep/seed-{S}/rollouts-{N}/{dataset_name}/
"""
...
def main(
    ...
    tag = f"dataset={dataset} seed={seed} corr={corr:.4f} rollouts={num_rollouts}"
