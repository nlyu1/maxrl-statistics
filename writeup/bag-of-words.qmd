...
<u>Null finding</u>: **no discernable difference in the heterogeneous setup**.

> The updated hypothesis is that heterogeneity via irreducible noise, along the purely
  statistical axis, is insufficient to differentiate the ML objective. The next step
  is to introduce true, semantic variability.
