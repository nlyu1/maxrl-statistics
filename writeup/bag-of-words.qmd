...
2. The next step is to sharpen the hypothesis that SL (maximum-likelihood) is better on harder-tasks.
  - Hypothesis: SL and GRPO differentiates only when there is **variation** in task difficulty.
...
Note that the x-axis is not uniformly scaled above! Some other findings of interest:
