    ...
    def serialize_at_end_of_epoch(
        ...
        *,
        ...
        corr_metrics = {
            ...
            "train_mse_target": float(train_target_stats.mse.squeeze(0).cpu()),
